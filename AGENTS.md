...
- Reusable systems live under `addons/`: `ocean_system`, `sky_system`, `wind_system`, `buoyancy_system`, `projectile_launcher_system`, `hitbox_damage_system`, and `floating_boat_template`. Read that addon's local `AGENTS.md` plus `HOW_TO_USE.md`/`CODEBASE.md` before changing behavior.
